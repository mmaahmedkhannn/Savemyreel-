...
const t: TranslationDict = {
    ...
    "hero.subtitle": {
        en: "Save videos, reels, and photos from Pinterest, Instagram, Facebook, TikTok, YouTube, and X without watermarks.",
        es: "Guarda videos, reels y fotos de Pinterest, Instagram, Facebook, TikTok, YouTube y X sin marcas de agua.",
        fr: "Sauvegardez vidéos, reels et photos de Pinterest, Instagram, Facebook, TikTok, YouTube et X sans filigrane.",
        de: "Speichern Sie Videos, Reels und Fotos von Pinterest, Instagram, Facebook, TikTok, YouTube und X ohne Wasserzeichen.",
        hi: "Pinterest, Instagram, Facebook, TikTok, YouTube और X से वीडियो, रील और फोटो बिना वॉटरमार्क के डाउनलोड करें।",
        ar: "احفظ الفيديوهات والريلز والصور من بنترست وإنستغرام وفيسبوك وتيك توك ويوتيوب و X بدون علامة مائية.",
        pt: "Salve vídeos, reels e fotos do Pinterest, Instagram, Facebook, TikTok, YouTube e X sem marca d'água.",
        ru: "Сохраняйте видео, рилсы и фото из Pinterest, Instagram, Facebook, TikTok, YouTube и X без водяных знаков.",
        ja: "Pinterest、Instagram、Facebook、TikTok、YouTube、Xから動画・リール・写真をウォーターマークなしで保存。",
        ko: "Pinterest, Instagram, Facebook, TikTok, YouTube, X에서 워터마크 없이 비디오, 릴, 사진을 저장하세요.",
        zh: "从Pinterest、Instagram、Facebook、TikTok、YouTube和X保存视频、Reels和照片，无水印。",
        tr: "Pinterest, Instagram, Facebook, TikTok, YouTube ve X'ten videoları, reelleri ve fotoğrafları filigranlı olmadan kaydedin.",
        it: "Salva video, reel e foto da Pinterest, Instagram, Facebook, TikTok, YouTube e X senza filigrana.",
        id: "Simpan video, reel, dan foto dari Pinterest, Instagram, Facebook, TikTok, YouTube, dan X tanpa watermark.",
        vi: "Lưu video, reels và ảnh từ Pinterest, Instagram, Facebook, TikTok, YouTube và X không có watermark.",
        th: "บันทึกวิดีโอ, รีล และรูปภาพจาก Pinterest, Instagram, Facebook, TikTok, YouTube และ X โดยไม่มีลายน้ำ",
        nl: "Bewaar video's, reels en foto's van Pinterest, Instagram, Facebook, TikTok, YouTube en X zonder watermerk.",
        pl: "Zapisuj filmy, reelsy i zdjęcia z Pinterest, Instagrama, Facebooka, TikToka, YouTube'a i X bez znaku wodnego.",
        cs: "Ukládejte videa, reels a fotky z Pinterestu, Instagramu, Facebooku, TikToku, YouTube a X bez vodoznaku.",
        ro: "Salvați videoclipuri, reels și fotografii de pe Pinterest, Instagram, Facebook, TikTok, YouTube și X fără filigran.",
        sv: "Spara videor, reels och foton från Pinterest, Instagram, Facebook, TikTok, YouTube och X utan vattenstämpel.",
        sk: "Uložte videá, reels a fotky z Pinterestu, Instagramu, Facebooku, TikToku, YouTube a X bez vodoznaku.",
        ms: "Simpan video, reel dan foto dari Pinterest, Instagram, Facebook, TikTok, YouTube dan X tanpa tera air.",
        fa: "ویدیو، ریلز و عکس‌ها را از پینترست، اینستاگرام، فیسبوک، تیک‌تاک، یوتیوب و X بدون واترمارک ذخیره کنید.",
    },
    "hero.paste": {
    ...
    // ─── Footer ───
    "footer.tagline": {
        en: "Free online video downloader for Pinterest, Instagram, TikTok, Facebook, YouTube & X. Save reels, videos, and photos in HD.",
        es: "Descargador de videos en línea gratuito para Pinterest, Instagram, TikTok, Facebook, YouTube y X.",
        fr: "Téléchargeur de vidéos en ligne gratuit pour Pinterest, Instagram, TikTok, Facebook, YouTube et X.",
        de: "Kostenloser Online-Video-Downloader für Pinterest, Instagram, TikTok, Facebook, YouTube & X.",
        hi: "Pinterest, Instagram, TikTok, Facebook, YouTube और X के लिए मुफ्त ऑनलाइन वीडियो डाउनलोडर।",
        ar: "أداة تحميل فيديو مجانية لبنترست وإنستغرام وتيك توك وفيسبوك ويوتيوب و X.",
        pt: "Baixador de vídeos online gratuito para Pinterest, Instagram, TikTok, Facebook, YouTube e X.",
        ru: "Бесплатный онлайн-загрузчик видео для Pinterest, Instagram, TikTok, Facebook, YouTube и X.",
        ja: "Pinterest、Instagram、TikTok、Facebook、YouTube、X用の無料動画ダウンローダー。",
        ko: "Pinterest, Instagram, TikTok, Facebook, YouTube, X용 무료 온라인 비디오 다운로더.",
        zh: "免费在线视频下载器，支持Pinterest、Instagram、TikTok、Facebook、YouTube和X。",
        tr: "Pinterest, Instagram, TikTok, Facebook, YouTube ve X için ücretsiz video indirici.",
        it: "Downloader video online gratuito per Pinterest, Instagram, TikTok, Facebook, YouTube e X.",
        id: "Pengunduh video online gratis untuk Pinterest, Instagram, TikTok, Facebook, YouTube & X.",
        vi: "Trình tải video trực tuyến miễn phí cho Pinterest, Instagram, TikTok, Facebook, YouTube & X.",
        th: "ตัวดาวน์โหลดวิดีโอออนไลน์ฟรีสำหรับ Pinterest, Instagram, TikTok, Facebook, YouTube และ X",
        nl: "Gratis online videodownloader voor Pinterest, Instagram, TikTok, Facebook, YouTube & X.",
        pl: "Darmowy pobieracz wideo online dla Pinterest, Instagram, TikTok, Facebook, YouTube i X.",
        cs: "Bezplatný online stahovač videí pro Pinterest, Instagram, TikTok, Facebook, YouTube a X.",
        ro: "Descărcător video online gratuit pentru Pinterest, Instagram, TikTok, Facebook, YouTube și X.",
        sv: "Gratis nedladdare för Pinterest, Instagram, TikTok, Facebook, YouTube & X-videor.",
        sk: "Bezplatný online sťahovač videí pre Pinterest, Instagram, TikTok, Facebook, YouTube a X.",
        ms: "Pemuat turun video dalam talian percuma untuk Pinterest, Instagram, TikTok, Facebook, YouTube & X.",
        fa: "دانلودر رایگان ویدیو آنلاین برای پینترست، اینستاگرام، تیک‌تاک، فیسبوک، یوتیوب و X.",
    },
    "footer.legal": {
