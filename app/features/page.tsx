...
export const metadata: Metadata = {
    ...
    description: "Explore SaveMyReel's powerful features: HD video downloads, no watermark, multi-platform support for Instagram, TikTok, Facebook, YouTube & X. Fast, free, and privacy-focused.",
...
const features = [
    ...
    { emoji: "🎬", title: "HD & 4K Quality", description: "Download Instagram Reels, TikTok videos, and Facebook clips in their original HD resolution (1080p, 4K) when available. Always the highest quality." },
    ...
    { emoji: "🌐", title: "Multi-Platform Support", description: "Download from Instagram, Facebook, TikTok, and X (Twitter). Support for reels, videos, photos, carousels, GIFs, and stories." },
                    ...
                    <section className={styles.section} style={{ marginTop: "3rem" }}>
                        ...
                        <div style={{
                            ...
                            {[
                                ...
                                { emoji: "▶️", name: "YouTube", desc: "Videos, Shorts, MP4 & Audio" },
